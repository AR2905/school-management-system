...
import { customZodResolver, subjectSchema, SubjectSchema } from "@/lib/formValidationSchemas";
import { CreateNestedField, createSubject, UpdateNestedFields, updateSubject } from "@/lib/actions";
...
const SubjectForm = ({
  ...
  const {
    ...
    resolver: customZodResolver(subjectSchema),
  });
  ...
  const { teachers , AllCustomFields } = relatedData;

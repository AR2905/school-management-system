...
import { customZodResolver, parentSchema, ParentSchema, teacherSchema, TeacherSchema } from "@/lib/formValidationSchemas";
import { useFormState } from "react-dom";
import { CreateNestedField, createParent, createTeacher, UpdateNestedFields, updateParent } from "@/lib/actions";
...
const ParentForm = ({
  ...
  const {
    ...
    resolver: customZodResolver(parentSchema),
  });

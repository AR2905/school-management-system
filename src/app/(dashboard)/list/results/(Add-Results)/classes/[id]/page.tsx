...
const renderRow = (item: ClassList) => {
    ...
    >
      ...
      <td>
        <div className="flex items-center gap-2">
            ...
            <> 
            <Link href={`/list/results/classes/${params.id}/lesson/${item.id}`} className="p-1 rounded-full text-white hover:bg-blue-500 bg-blue-300 text-center">Go</Link>
  ...
  const [data, count] = await prisma.$transaction([
    ...
    <div className="flex items-center justify-between">
      <h1 className="hidden md:block text-lg font-semibold  ">All Lessons of classId {params.id}</h1>

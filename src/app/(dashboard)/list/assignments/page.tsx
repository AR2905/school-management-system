          ...
          {role === "admin" && (
              ...
              <div className="one flex items-end flex-col gap-2  justify-center ">
                <div className="FirstBox flex gap-2 items-center">
                  <span>Custom </span>
                  <FormContainer table="custom" type="create" data="Assignment" />
                </div>
...
//       break;
//     case "teacher":
//       query.lesson.teacherId = currentUserId!; // Ensure teacher sees their assignments
//       break;
//     case "student":
//       query.lesson.class = {
//         students: {
//           some: {
//             id: currentUserId!, // Ensure student sees assignments for their class
//           },
//         },
//       };
//       break;

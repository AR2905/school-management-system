...
export default function Loading () { 
    ...
    // return <h1 className="loading-h w-[100vw] h-[100vh] bg-[#edf9fd] flex justify-center items-center mb-8">
    //   <span className="let1 loading-span">l</span>  
    //   <span className="let2 loading-span">o</span>  
    //   <span className="let3 loading-span">a</span>  
    //   <span className="let4 loading-span">d</span>  
    //   <span className="let5 loading-span">i</span>  
    //   <span className="let6 loading-span">n</span>  
    //   <span className="let7 loading-span">g</span>  
    // </h1>

    return <div className='flex justify-center items-center w-screen h-screen bg-[#edf9fd]'>
